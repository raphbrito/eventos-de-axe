...
const CONFIG = {
    API_URL:
        "https://script.google.com/macros/s/AKfycbwKgsm55O1Ab4fsRcNl2Sk1ivg3SYtpOeKEJmXNrBzULAjUvAs28hnAIBX6xCPxgiUg/exec",
...
async function fetchDashboardData(username, password) {
    ...
    localStorage.setItem("eventos-axe.session-token", login.data.token);
...
function logout() {
    localStorage.removeItem("eventos-axe.session-token");
